...
struct DirectionButton: NSViewRepresentable {
    ...
    class ClickableView: NSView {
        ...
        var item: TickerItem?
        var binding: Binding<TickerItem>?
        ...
        func configure(with item: TickerItem, binding: Binding<TickerItem>) {
            self.item = item
        ...
        private func makeIcon(for item: TickerItem) -> some View {
            Group {
